        ...
        <div className=" md:flex border-b-4 border-red-400 bg-white">
            ...
            <div className="w-full h-auto  px-6 py-12 md:px-24 md:py-24 text-center md:text-left">
                ...
                <p className="text-lg md:text-xl mt-6 md:mt-9 font-serif leading-relaxed font-medium ">
                    "Hi, I’m a passionate web developer eager to create beautiful and functional websites. I specialize in building user-friendly interfaces and seamless web experiences using modern tools like Next.js and Sanity.io. As a beginner developer, I’m always learning and excited to grow my skills, tackling new challenges with enthusiasm. Whether it's designing responsive layouts or optimizing website performance, I’m committed to delivering value through my work. Let’s connect and build something amazing together!"
                </p>
            </div>
